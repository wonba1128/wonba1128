# Hello world!
**Data Engineer** passionate about building stable pipelines & infrastructure.
...
* **Data Engineering & ETL** (Airflow, Python, SQL)
* **Cloud Infrastructure** (AWS EC2, S3, RDS, VPC)
* **Container & Orchestration** (Docker, Docker Compose)
* **Monitoring & Observability** (Prometheus, Grafana)
* **Web Crawling & Automation** (Selenium, BS4)
...
* 교육용 챗봇 프로젝트(Data Pipeline & Infra)를 진행 했습니다. **[Edu-Chatbot Project](https://github.com/Edu-Navigator/Edu-Chatbot)**
